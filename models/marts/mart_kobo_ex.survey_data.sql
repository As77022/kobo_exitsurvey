...
SELECT
    ...
    "gender"	,
    "student_unique_id"	,
    "student_unique_id_new" AS "exit_student_id"	,
    "father_name"	,
    "mother_name"	,
    ...
    CAST(NULL AS TEXT) AS "exit_survey_status",
    ...
    CAST(NULL AS boolean) AS "is_assessment_required",
    CAST(NULL AS VARCHAR(20)) AS "assessment_conducted",
    CAST(NULL AS VARCHAR(20)) AS "trainingtype",
