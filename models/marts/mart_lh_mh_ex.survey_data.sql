...
TrainingType,
    ...
    CAST(NULL AS VARCHAR(15)) AS "start_date",
    CAST(NULL AS VARCHAR(15)) AS "end_date",
    CAST(NULL AS VARCHAR(30)) AS "today",
    ...
    CAST(NULL AS VARCHAR(30)) AS "student_unique_id_new",
