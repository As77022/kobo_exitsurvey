...
WITH cte AS 
    ...
    "willing_to_conti_ve_in_11th_"	AS	"willing_to_conti_ve_in_11th"	,
    "reason_not_conti_high_educ_"	AS	"reason_not_conti_high_educ"	,
    "reason_not_conti_high_educ__financial"	AS	"reason_not_conti_high_educ_financial"	,
    "reason_not_conti_high_educ__need_a_job"	AS	"reason_not_conti_high_educ_need_a_job"	,
    "reason_not_conti_high_educ__family_not_allow"	AS	"reason_not_conti_high_educ_family_not_allow"	,
    "reason_not_conti_high_educ__not_interested"	AS	"reason_not_conti_high_educ_not_interested"	,
    "reason_not_conti_high_educ__failed_in_current"	AS	"reason_not_conti_high_educ_failed_in_current"	,
    "reason_not_conti_high_educ__school_till_10th_only"	AS	"reason_not_conti_high_educ_school_till_10th_only"	,
    "reason_not_conti_high_educ__marriage"	AS	"reason_not_conti_high_educ_marriage"	,
    "reason_not_conti_high_educ__other"	AS	"reason_not_conti_high_educ_other"	,
    "reasons_not_conti_ve_in_11th_"	AS	"reasons_not_conti_ve_in_11th"	,
    ...
    "are_you_currently_working__job_own_business_etc_"	AS	"are_you_currently_working_job_own_business_etc"	,
    ...
    "are_you_intrested_in_doing_apprentice___naps_"	AS	"are_you_intrested_in_doing_apprentice_naps_"	,
    "parent_index"	AS	"parent_index"	,
    "submission_id"	AS	"submission_id"	,
    "submission_uuid"	AS	"submission_uuid"
FROM {{source("kobo_exitsurvey","ld_10-12th_exitsurvey_kobo")}})
select * from cte